...
func TestGetEaster(t *testing.T) {
	tests := []struct {
		...
		{2024, time.Date(2024, 3, 31, 0, 0, 0, 0, time.UTC)}, // 2024 Easter Sunday
		{2023, time.Date(2023, 4, 9, 0, 0, 0, 0, time.UTC)},  // 2023 Easter Sunday
		{2022, time.Date(2022, 4, 17, 0, 0, 0, 0, time.UTC)}, // 2022 Easter Sunday
		{2021, time.Date(2021, 4, 4, 0, 0, 0, 0, time.UTC)},  // 2021 Easter Sunday
	}
